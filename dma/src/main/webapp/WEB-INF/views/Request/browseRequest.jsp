...
<link href="${contextApp}/resources/x-editable/css/bootstrap-editable.css" rel="stylesheet">
<script src="${contextApp}/resources/x-editable/js/bootstrap-editable.min.js"></script>
