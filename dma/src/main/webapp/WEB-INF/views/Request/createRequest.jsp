...
<%@ page session="false"%>
<script type="text/javascript" src="${contextApp}/resources/ckeditor-3.6.6.1/ckeditor.js"></script>
<script type="text/javascript" src="${contextApp}/resources/js/common.js"></script>
<script type="text/javascript" src="${contextApp}/resources/js/createRequest.js"></script>
<link rel="stylesheet" type="text/css" href="${contextApp}/resources/chosen/chosen.min.css" />
<link type="text/css" href="${contextApp}/resources/jquery-ui/1.9.2/themes/base/jquery.ui.all.css" rel="stylesheet">
<script type="text/javascript" src="${contextApp}/resources/jquery/1.9.1/jquery-1.9.1.js"></script>
<script type="text/javascript" src="${contextApp}/resources/jquery-ui/1.9.2/ui/jquery-ui-1.9.2.js"></script>
<script type="text/javascript" src="${contextApp}/resources/jquery-ui/1.9.2/ui/jquery.ui.datepicker.js"></script>
<script type="text/javascript" src="${contextApp}/resources/jquery-ui/1.9.2/ui/i18n/jquery.ui.datepicker-vi.js"></script>
<script type="text/javascript" src="${contextApp}/resources/js/validateFunction.js"></script>
<%@ include file="../_common/_includeGeneralScreen.jsp" %>
