...
<link rel="stylesheet" href="${contextApp}/resources/jstree/themes/default/style.min.css" />
<script src="${contextApp}/resources/jstree/jstree.min.js"></script>
...
<script>
    $(document).ready(function() {
        ...
        container.handsontable({
            ...
            startCols: 6,
            rowHeaders: true,
            colHeaders: ['Tài khoản', 'Email', 'Họ', 'Tên','Mã công ty', 'Trạng thái'],
            colWidths: [160, 160, 150, 100, 100, 110],
