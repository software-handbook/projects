...
public class SystemService extends BaseService {
    ...
    public SystemService(String groupName) {
        super(groupName);
    }
    ...
    */
    public boolean initData(String username) {
        ...
        if (initOK) {
            ...
            initOK = initCreateSystemDepartment(username);
        } else {
           return false;
        }
        
        if (initOK) {
            initOK = initSystemUser(username);
        } else {
            return false;
        }
    ...
    * false: Data is existed or error
    */
    private boolean initCreateSystemDepartment(String username) {
    ...
    private boolean initSystemUser(String username) {
        boolean isEnable = true;
        User user = new User();
    ...
    */
    private boolean initStatusFlow(String username) {
        ExStatusFlowJpaController daoCtrl = new ExStatusFlowJpaController(emf);
