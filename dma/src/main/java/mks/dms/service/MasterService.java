...
public class MasterService extends BaseService {
    ...
    public MasterService(String groupId) {
        super(groupId);
    }
    
    public List<Department> getDepartments() {
        ExDepartmentJpaController daoCtrl = new ExDepartmentJpaController(this.emf);
    ...
    public RequestService getRequestService() {
        ...
        if (requestService == null) {
            requestService = new RequestService(this.groupId);
        }
    ...
    * @param data
    * Structure of a row:
    * User name, Email, Last name, First name, Group Id
     * @param authUsername 
    ...
    */
    ...
    public RequestTypeJpaController getRequestTypeDaoController() {
    ...
    public User findUserByUsername(String username) {
        ExUserJpaController userDaoCtrl = new ExUserJpaController(this.emf);
    ...
    */
    ...
    public String getJsonRequestTypes() {
        RequestTypeModel requestTypeModel = new RequestTypeModel(this.groupId); 
    ...
    public String getJsonSystemUser() {
    ...
    public String getJsonStatusFlowRequest() {
        StatusFlowModel statusFlowModel = new StatusFlowModel(); 

        StatusFlowJpaController statusDaoCtrl = new StatusFlowJpaController(this.emf);
    ...
    public String getJsonParameter() {
        ...
        ParameterJpaController parameterDaoCtrl = new ParameterJpaController(this.emf);
    ...
    */
    public RequestTypeModel saveAllRequestType(RequestTypeModel requestTypeModel, String username) throws SaveBatchException {
        ExRequestTypeJpaController requestTypeDaoCtrl = new ExRequestTypeJpaController(this.emf);
    ...
    public DepartmentModel saveAllDepartment(DepartmentModel departmentModel, String username) throws SaveBatchException {
        ExDepartmentJpaController departmentDaoCtrl = new ExDepartmentJpaController(this.emf);
    ...
    public StatusFlowModel saveAllStatusFlowRequest(StatusFlowModel statusFlowModel, String username) throws SaveBatchException {
        ExStatusFlowJpaController statusFlowDaoCtrl = new ExStatusFlowJpaController(this.emf);
    ...
    public ParameterModel saveAllParameter(ParameterModel parameterModel, String username) throws SaveBatchException {
        ExParameterJpaController parameterDaoCtrl = new ExParameterJpaController(this.emf);
