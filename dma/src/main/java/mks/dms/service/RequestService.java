...
public class RequestService extends BaseService {
	...
	private ExRequestJpaController controller = null;

	private MasterService masterService;

	public RequestService() {
        super();
        controller = new ExRequestJpaController(masterEmf);
        masterService = new MasterService();
	}
	
    public RequestService(String groupName) {
        super(groupName);
        controller = new ExRequestJpaController(emf);
        
        masterService = new MasterService(groupName);
    }
...
//	}
	...
	*/
	public void saveRate(Integer requestId, Rate rate) throws ServiceException {
	    ...
	    ExRateJpaController rateDaoCtrl = new ExRateJpaController(this.emf);
    ...
    */
    private void updateReferenceData(Request request, int mode) {
        ...
        ExRequestTypeJpaController reqTypeJpaCtrl = new ExRequestTypeJpaController(this.emf);
...
//        request.setStatus(AppCons.STATUS_CREATED);
    ...
    * @return
    */
    public List<Request> findAnnouncement(String groupName) {
        List<Request> lstRequest;
        lstRequest = controller.findRequestByType(AppCons.ANNOUNCEMENT, groupName);
    ...
    */
    ...
    public List<Request> findRule(String groupName) {
        List<Request> lstRequest;
        lstRequest = controller.findRequestByType(AppCons.RULE, groupName);
    ...
    */
    ...
    public List<Request> findRequestOfUserByCondition(String username, SearchRequestConditionModel searchCond, String groupId) {
        return controller.findRequestOfUserByCondition(username, searchCond, groupId);
    }
    ...
    */
    ...
    public List<Comment> findCommentByRequestId(Integer requestId) {
        ExCommentJpaController commentDaoCtrl = new ExCommentJpaController(this.emf);
    ...
    */
    public Comment findCommentById(int requestId, int commentId) {
        ExCommentJpaController comDaoCtrl = new ExCommentJpaController(this.emf);
