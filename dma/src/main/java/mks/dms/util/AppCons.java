...
public class AppCons {
    ...
    */
    ...
    public static final String PARAM_TEMPLATE_WELCOME_CONTENT = "EmailWelcomeContent";
    public static final String PARAM_TEMPLATE_WELCOME_TITLE = "EmailWelcomeTitle";
    ...
    public static final String NO_INPUT_PHONE = "0";
    public static final String SYSTEM = "SYSTEM";

    public static final String DEFAULT_GROUP = "dma-master";
}
