...
//        // Get request
//        RequestJpaController reqCtrl = new RequestJpaController(BaseService.getEmf(DEFAULT_GROUP));
//        Request req = reqCtrl.findRequest(4);
//        
//        req.setTitle(req.getTitle() + " Updated at " + new Date());
//        
//        RequestService reqService = new RequestService(DEFAULT_GROUP);
...
//        assertEquals(2, retCd);
    ...
    public void testFindByCondition() {
        ExRequestJpaController reqCtrl = new ExRequestJpaController(BaseService.getEmf(DEFAULT_GROUP));
