...
DROP TABLE IF EXISTS GROUP_PERSISTENT;
...
CREATE TABLE USER (
     ...
     , GROUP_ID VARCHAR(20) NOT NULL           -- Mapping to a private database
...
CREATE TABLE PARAMETER (
     ...
     , LASTMODIFIEDBY_USERNAME VARCHAR(50)
     , PRIMARY KEY (ID)
     , CONSTRAINT NODUPLICATE UNIQUE (CD, NAME, ENABLED)
);
 ...
 */
CREATE TABLE GROUP_PERSISTENT (
       ID INT NOT NULL AUTO_INCREMENT
     , GROUP_ID VARCHAR(20) NOT NULL UNIQUE
     , DBNAME VARCHAR(20) NOT NULL UNIQUE
     , JDBC_DRIVER VARCHAR(50) NOT NULL
     , JDBC_URL VARCHAR(50) NOT NULL
