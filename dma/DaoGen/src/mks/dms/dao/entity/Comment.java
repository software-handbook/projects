...
@NamedQueries({
    ...
    @NamedQuery(name = "Comment.findByGroupId", query = "SELECT c FROM Comment c WHERE c.groupId = :groupId"),
...
public class Comment implements Serializable {
    ...
    public Comment(Integer id, int reqId, String reqStatus, String username, String groupId, Date created, String createdbyUsername) {
        this.id = id;
        this.reqId = reqId;
