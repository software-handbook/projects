...
@NamedQueries({
    ...
    @NamedQuery(name = "Department.findByGroupId", query = "SELECT d FROM Department d WHERE d.groupId = :groupId"),
...
public class Department implements Serializable {
    ...
    public Department(Integer id, int parentid, String cd, String name, String groupId, Date created, String createdbyUsername) {
        this.id = id;
