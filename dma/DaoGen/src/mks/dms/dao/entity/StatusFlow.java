...
@NamedQueries({
    ...
    @NamedQuery(name = "StatusFlow.findByGroupId", query = "SELECT s FROM StatusFlow s WHERE s.groupId = :groupId"),
...
public class StatusFlow implements Serializable {
    ...
    public StatusFlow(Integer id, int seqNo, String requesttypeCd, String typeUser, String currentStatus, String nextStatus, String groupId, Date created, String createdbyUsername) {
        this.id = id;
        this.seqNo = seqNo;
