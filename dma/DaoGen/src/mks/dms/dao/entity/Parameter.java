...
@NamedQueries({
    ...
    @NamedQuery(name = "Parameter.findByGroupId", query = "SELECT p FROM Parameter p WHERE p.groupId = :groupId"),
...
public class Parameter implements Serializable {
    ...
    public Parameter(Integer id, String cd, String groupId, Date created, String createdbyUsername) {
        this.id = id;
        this.cd = cd;
