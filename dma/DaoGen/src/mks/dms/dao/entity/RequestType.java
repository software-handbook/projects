...
@NamedQueries({
    ...
    @NamedQuery(name = "RequestType.findByGroupId", query = "SELECT r FROM RequestType r WHERE r.groupId = :groupId"),
...
public class RequestType implements Serializable {
    ...
    public RequestType(Integer id, String cd, String name, String groupId, Date created, String createdbyUsername) {
        this.id = id;
        this.cd = cd;
        this.name = name;
